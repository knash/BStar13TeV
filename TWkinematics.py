...
if jobs != 1:
	f = TFile( "TWkinematics"+options.set+"_Trigger_"+trig+"_"+options.modulesuffix +pustr+pstr+mmstr+"_job"+options.num+"of"+options.jobs+"_PSET_"+options.cuts+".root", "recreate" )
else:
	f = TFile( "TWkinematics"+options.set+"_Trigger_"+trig+"_"+options.modulesuffix +pustr+pstr+mmstr+"_PSET_"+options.cuts+".root", "recreate" )
